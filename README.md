...
- **💾 Manter só os normalizados** — apague os arquivos originais (mantendo o `.ts` que vai ao ar) por vídeo, em lote ou automaticamente após normalizar; preserva os usados por canais em modo cópia/transcode
